...
function generateYML () {
    ...
    asset_id_from_yml=$(cat $config_file | jq -r '.application.assetId') 
    ...
    echo "synopsys-io.json generated"
}
...
function loadWorkflow() {
    ...
    asset_id_from_yml=$(cat synopsys-io.json | jq -r '.application.assetId')
...
function getIOPrescription() {
    ...
    echo synopsys-io.json > data.json
    cat data.json
