...
function loadWorkflow() {
    ...
    scandateresponse=$(curl -X POST -H 'Content-Type:application/json' -H 'Accept:application/json' -H "${header}" -d @scandate.json ${io_url}/stargazer/api/manifest/update/scandate)
